---
id: load-customer-intention
name: "Load Customer Intention (aine-aine-orchestration)"
description: "Validate the intention YAML, surface missing fields, prompt the FDE for clarifications."
trigger: command
phrase: "/load-customer"
---


## Objective

Validate the intention YAML, surface missing fields, prompt the FDE for clarifications. This skill is one of several in **AINE Orchestration Layer**; agents executing this skill should also surface related skills from the same program if the customer's situation calls for them.
